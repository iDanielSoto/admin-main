...
const Sidebar = ({
  ...
  const visibleItems = sidebarItems.filter(
    (item) => item.alwaysVisible || !disabledModules.includes(item.tab)
  );
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-20 bg-[#1E293B] text-white flex flex-col items-center py-4 space-y-4">
      ...
      <div className="mt-auto">
        <button
          onClick={onLogout}
          className="text-gray-300 hover:bg-gray-700 p-3 rounded"
        >
          <LogOut />
        </button>
      </div>
...
const AdminDashboard = () => {
  ...
  const [employees, setEmployees] = useState([
    ...
    },
    {
      id: 2,
      name: "Edgar Yahir SS",
      email: "misterxxzx@gmail.com",
      role: "Administrador",
      department: "Tecnología",
      password: "Yristan",
      imageUrl:
        "https://cdn.discordapp.com/attachments/1365377054455103508/1384779752589492275/StellarPlace.jpg?ex=685f89a4&is=685e3824&hm=c72c7aecdf20fa1b1ea0d7cf96543e123dcff7037efe0f07188593491f084efe&",
    },
  ]);
  const [roles, setRoles] = useState([
    ...
    },
    {
      id: 2,
      name: "Escritura",
      description: "Puede modificar información",
      permissions: [1, 2],
    },
    {
      id: 3,
  ...
  const [departments, setDepartments] = useState([
    {
      ...
      coordinates: [
        [18.025767, -102.207978],
        [18.025864, -102.206755],
        [18.025007, -102.206336],
        [18.025404, -102.206905],
      ],
      color: "#FF0000",
      fillColor: "#FFAAAA",
    },
    {
      id: 2,
      name: "Tecnología",
      description: "Desarrollo e infraestructura tecnológica",
      coordinates: [
        [18.0245, -102.207],
        [18.0246, -102.206],
        [18.0238, -102.2056],
  ...
  const [permissions, setPermissions] = useState([
    {
      ...
      name: "Lectura",
      description:
        "Permite la vista de todos los componentes, no tiene permiso a modificar nada.",
      category: "Vista",
    },
    {
      id: 2,
      name: "Jefe Area de Sistemas",
      description: "Permite modificar y ver la información de tu departamento",
  ...
  useEffect(() => {
    if (currentUser && isLoggedIn) {
      ...
      if (updatedUser) {
        ...
        handleLogout();
        alert(
          "Tu cuenta ha sido eliminada. Has sido desconectado automáticamente."
        );
      }
    }
  }, [employees]);
  ...
  const handleLoginSuccess = (userCredentials) => {
    const user = employees.find(
      (emp) =>
        emp.email === userCredentials.email &&
        emp.password === userCredentials.password
    );
    if (user) {
      setCurrentUser(user);
      setIsLoggedIn(true);
  ...
  const handleRegisterSuccess = (newUserData) => {
    ...
    addLogEntry(
      ...
      "Usuario",
      newUserWithId.name,
      `Nuevo usuario registrado: ${newUserWithId.name}`
    );
  };
  ...
  const hasPermission = (permissionName) => {
    ...
    if (
      (permissionName === "Escritura" || permissionName === "Administrador") &&
  ...
  const handleUpdateDepartmentFromMap = (updatedDept) => {
    ...
    addLogEntry(
      ...
      "Departamento",
      updatedDept.name,
      `Coordenadas del departamento actualizadas desde el mapa: ${updatedDept.name}`
    );
  };
  ...
  const handleUpdateSettings = (field, value) => {
    ...
    addLogEntry(
      ...
      "Sistema",
      field,
      `Configuración actualizada: ${field}`
    );
  };
  ...
  const handleEmployeeDelete = (employeeId) => {
    ...
    if (isSelfDelete) {
      setTimeout(() => {
        alert(
          "Has eliminado tu propia cuenta. Serás desconectado automáticamente."
        );
      }, 100);
    }
  };
  ...
  const renderContent = () => {
        ...
        <div className="flex items-center justify-center h-full">
          <div className="text-center bg-white rounded-2xl shadow-lg p-8">
            ...
            <p className="text-gray-600">
              Este módulo ha sido deshabilitado por el administrador.
            </p>
          </div>
        </div>
      );
    ...
    switch (activeTab) {
      ...
      default:
        return (
          <WelcomeDashboard currentUser={currentUser} settings={settings} />
        );
    }
  };
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      />
      <div className="flex-grow p-6 ml-20 overflow-auto">{renderContent()}</div>
    </div>
  );
};
